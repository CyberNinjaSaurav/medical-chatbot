...
export function LoginPage() {
  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-4">
      ...
      <h1 className="font-display mt-2 text-3xl font-bold text-heading">GWAK Clinical</h1>
      <p className="mt-2 text-body">Clinical workspace for verified physicians</p>
